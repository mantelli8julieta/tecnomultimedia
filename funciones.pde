void rayasCelestes12(int posInicial1C, int largoLinea1C, int mouseX, color celeste, color random) {
  float cant1c = 10;
  float cant2c = 13.5;
  stroke(celeste);
  strokeWeight(8);
...
void rayasCelestes345(int posInicial2C, int largoLinea2C, int mouseX,  color celeste, color random) {
  float cant3c = 10;
  float cant4c = 13.5;
  float cant5c = 10;
  stroke(96, 162, 170);
...
void rayasCelestes67(int posInicial3C, int largoLinea3C, int mouseX,  color celeste, color random ) {
  float cant6 = 13.5;
  float cant7 = 10;
  stroke(96, 162, 170);
  strokeWeight(7.5);
...
void rayasRojasFila1uno(int posInicialF1unoR, int largoLineaF1unoR, int posInicialF1dosR, int largoLineaF1dosR, int mouseX, color rojo, color random) {
  float cant1 = 4;
  float cant2 = 6;
  stroke(232, 94, 94);
  strokeWeight(2);
...
void rayasRojasFila1dos(int posInicial1dosR, int largoLinea1dosR, int mouseX,  color rojo, color random) {
  float cant1 = 14;
  float cant2 = 15;
  stroke(232, 94, 94);
  strokeWeight(2);
...
void rayasRojasFila2(int PInicialF2, int LLineaF2, int mouseX,  color rojo, color random) {
  float cant1 = 8;
  float cant2 = 10;
  float cant3 = 13;
  float cant4= 11;
...
void rayasRojasFila3(int PInicialF3, int LLineaF3, int mouseX,  color rojo, color random) {
  float cant1 = 9;
  float cant2 = 11;
  stroke(232, 94, 94);
  strokeWeight(2);
...
void rayasRojasFila4(int PInicialF4, int LLineaF4, int mouseX,  color rojo, color random) {
  float cant1 = 13;
  float cant2 = 15;
  stroke(232, 94, 94);
  strokeWeight(2);
...
void rayasRojasFila5(int PInicialF5, int LLineaF5, int mouseX,  color rojo, color random) {
  float cant1 = 13;
  float cant2 = 12;
  stroke(232, 94, 94);
  strokeWeight(2);
...
void rayasRojasFila6(int PInicialF6, int LLineaF6, int mouseX,  color rojo, color random) {
  float cant1 = 17;
  float cant2 = 16;
  stroke(232, 94, 94);
  strokeWeight(2);
...
void rayasRojasFila7(int PInicialF7, int LLineaF7, int mouseX, color rojo, color random) {
  float cant1 = 9;
  stroke(232, 94, 94);
  strokeWeight(2);
